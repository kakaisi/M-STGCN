...
for _ in range(1):
    def load_data(dataset):
        print("load data:")
        path = "../generate_data/DLPFC/" + dataset + "/M-STGCN.h5ad"
    ...
    if __name__ == "__main__":
        ...
        # datasets = ['151508', '151509', '151510', '151669', "151670",
        ...
        for i in range(len(datasets)):
            ...
            title = "Ground Truth (slice " + dataset + ")"
            sc.pl.spatial(adata, img_key="hires", color=['ground_truth'], palette=custom_colors, title=title,
                          show=False)
